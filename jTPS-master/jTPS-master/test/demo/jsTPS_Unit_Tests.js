...
import jsTPS_Controller from './jsTPS_Controller.js'
import jsTPS_View from './jsTPS_View.js'
...
export class jsTPS_Unit_Tests {
    ...
    constructor (name) {
        this.tester = document.getElementById(name);
    }
    ...
    runTest() {
        ...
        var num = new Num();
        var TPS = new jsTPS1();
        var TPSView = new jsTPS_View(TPS, num);
        var controller = new jsTPS_Controller(TPSView, TPS, num);
    }
